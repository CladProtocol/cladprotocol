...
function Block({ block }: { block: DocBlock }) {
  switch (block.kind) {
    case "h":
      return (
        <h2
          className="text-[22px] font-medium text-gray-900 mt-10 mb-4"
    ...
    case "p":
      return (
        <p className="text-[15px] sm:text-[16px] text-gray-600 leading-[1.7] mb-5">{block.text}</p>
      );
    case "list":
      return (
    ...
    <section className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12 pt-10 sm:pt-12 pb-16 sm:pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-8 lg:gap-12">
        <aside className="lg:sticky lg:top-3 self-start">
          <div className="text-[11px] uppercase tracking-wider text-gray-500 mb-3 px-3">
            On this protocol
          </div>
