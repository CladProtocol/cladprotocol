          ...
          <table className="w-full text-[13px] sm:text-[14px]">
            ...
            <tbody>
              {rows.map((i) => (
                ...
                >
                  <td className="py-3.5">
                    <Link href={`/dashboard/fleet/${i.id}`} className="block">
                  ...
                  <td className="py-3.5 px-2 text-gray-500 hidden md:table-cell">
                    {timeAgo(i.lastActivityAt)}
                  </td>
                  <td className="py-3.5 px-2 text-right font-medium text-gray-900">
                    ${i.earnings.toLocaleString()}
                  </td>
                  <td className="py-3.5">
                    <Link
                      href={`/dashboard/fleet/${i.id}`}
...
export default function FleetPage() {
  return (
    <Suspense fallback={<div className="py-32 text-center text-gray-400">Loading fleet…</div>}>
      <FleetContent />
    </Suspense>
  );
}
