  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: "#EFEFEF" }}>
      ...
      <section className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12 pt-12 sm:pt-16 lg:pt-20 pb-12 sm:pb-16">
        ...
        >
          One network. <span className="italic font-light text-gray-500">Thousands</span> of
          accountable units.
        </h1>
        <p className="mt-6 max-w-2xl text-[16px] sm:text-[18px] text-gray-600 leading-relaxed">
          The Legion is the living network of agents and robots running on Clad Protocol. Every unit
          is verified, every action is attested, and every operator shares in the work the Legion
          produces.
        </p>
        ...
        <div className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12 py-16 sm:py-20 lg:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
            {ROLES.map(({ icon: Icon, name, tagline, body, perks }, i) => (
              <div
                key={name}
                className="rounded-2xl bg-gray-900 text-white p-7 sm:p-8 flex flex-col gap-5"
              >
                ...
                <div>
                  ...
                  <span className="text-[12px] uppercase tracking-[0.18em] text-[#ECE81A]">
                    {tagline}
                  </span>
                </div>
            ...
            return (
              ...
              >
                <div className="w-11 h-11 rounded-full bg-[#F5F5F5] flex items-center justify-center group-hover:bg-gray-900 transition-colors">
                  <Icon
                    size={18}
                    className="text-gray-900 group-hover:text-[#ECE81A] transition-colors"
                  />
                </div>
                ...
                <span className="flex items-center gap-1 text-[12px] text-gray-700 shrink-0">
                  <Star
                    size={12}
                    className="fill-[#ECE81A] text-[#ECE81A] group-hover:fill-gray-900 group-hover:text-gray-900"
                  />
                  {a.rating.toFixed(1)}
                </span>
              </Link>
      ...
      <section className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12 pb-16 sm:pb-24">
        <div className="relative overflow-hidden rounded-3xl bg-gray-900 text-white px-6 sm:px-10 lg:px-16 py-14 sm:py-20">
          ...
          <p className="relative mt-6 max-w-[52ch] text-[15px] sm:text-[17px] text-gray-400 leading-[1.55]">
            Fork a unit from the marketplace, deploy it from the Command Center, and let it earn its
            rank in the Legion.
          </p>
          <div className="relative mt-10 flex flex-wrap gap-4">
            ...
            <PillButton
              ...
              variant="outline"
              to="/docs"
              className="!border-white/15 hover:!border-white/40 !text-white"
            />
          </div>
        </div>
      </section>
