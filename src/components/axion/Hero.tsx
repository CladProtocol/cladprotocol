      ...
      <div className="relative z-20 mx-auto w-full max-w-[1440px] px-5 sm:px-8 lg:px-12 pb-14 sm:pb-16 lg:pb-20">
        ...
        >
          <span className="sm:hidden">
            <span className="italic font-light text-gray-500">Autonomous</span> execution and
            ironclad verification for AI agents and physical robotics on Base.
          </span>
          <span className="hidden sm:inline" style={{ fontSize: "clamp(2.5rem,5vw,4.2rem)" }}>
            ...
            <br />
            <span className="italic font-light text-gray-500">Ironclad</span> verification for AI
            agents
            <br />
